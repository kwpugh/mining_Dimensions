...

{
    ...
    // OVERWORLD ORES
    public static final ConfiguredFeature<?, ?> ORE_EXTRA_DIAMOND_DEEPSLATE
    ...
    // NETHER ORES
    public static final ConfiguredFeature<?, ?> ORE_EXTRA_ANCIENT_DEBRIS
            = Feature.ORE.configure(new OreFeatureConfig(OreConfiguredFeatures.BASE_STONE_NETHER,
	...
	public static void init()
    {
        ...
        // NETHER ORES
        RegistryKey<ConfiguredFeature<?, ?>> extraAncientDebris = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
